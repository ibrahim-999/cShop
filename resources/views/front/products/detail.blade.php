                    ...
                    <div class="tab-content">
                            ...
                            <div class="row">
                                ...
                                <div class="span3 alignR">
                                    <form class="form-horizontal qtyFrm">
                                        <h3> US.{{$product['product_price']}}</h3>
                        ...
                        <div class="tab-pane active" id="blockView">
                            <ul class="thumbnails">
                                ...
                                <li class="span3">
                                    <div class="thumbnail">
                                        <a href="{{url('product/'.$product['id'])}}">@if(isset($productp['main_image']))
                                                <?php $product_image_path = 'images/product_images/small/'.$product['main_image']; ?>
                                            @else
                                                <?php $product_image_path = ''; ?>
                                            @endif
                                        ...
                                        <div class="caption">
                                            ...
                                            <h4 style="text-align:center"><a class="btn" href="{{url('product/'.$product['id'])}}"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">US.{{$product['product_price']}}</a></h4>
                                        </div>
                                    </div>
                                </li>
                                @endforeach

    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                @endif
                <form class="bannerForm" id="bannerForm"
                      @if(empty($banner['id']))
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        @if(!empty($banner['image']))
                                            <div><img style="width:220px; margin-top: 15px; margin-bottom: 5px;" src="{{asset('images/banner_images/'.$banner['image'])}}"></div>
                                        @endif
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="alt" id="alt" placeholder="Enter Banner Alternate Text" @if(!empty($banner['alt']))value="{{$banner['alt']}}" @else value="{{old('alt')}}" @endif>
                                    </div>
                                </div>
                                </div>
                            </div>
